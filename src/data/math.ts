export interface MathTopic {
  ...
  keyConcepts: { name: string; formula: string; description: string; relatedLinks?: { label: string; path: string }[] }[];
    ...
    keyConcepts: [
      {
        ...
        relatedLinks: [{"label":"基因表达向量 (学习路径 阶段1)","path":"/roadmap"}] as const,
      },
      {
        name: '矩阵乘法',
        ...
        relatedLinks: [{"label":"神经网络前向传播 (学习路径 阶段1)","path":"/roadmap"},{"label":"全连接层实现 (工具)","path":"/tools"}] as const,
      },
      {
        name: '点积',
        ...
        relatedLinks: [{"label":"注意力机制核心运算 (学习路径 阶段3)","path":"/roadmap"},{"label":"基因共表达相似度 (应用方向)","path":"/applications"}] as const,
      },
      {
        name: '特征分解',
        formula: 'Av = λv',
        description: '找到矩阵的主要方向(特征向量)和对应的缩放因子(特征值)，是PCA的核心数学操作。在生物信息学中，对基因表达矩阵的协方差矩阵进行特征分解，可以找到主导表达变化的主要基因模块(如细胞周期模块)。',
        relatedLinks: [{"label":"PCA降维 (学习路径 阶段2)","path":"/roadmap"},{"label":"基因表达模块 (应用方向)","path":"/applications"}] as const,
      },
      {
        name: 'SVD',
        formula: 'A = UΣV^T',
        description: '任意矩阵的分解方法，将数据分解为正交基底和奇异值。在生物信息学中，SVD用于基因表达数据的降噪(去除小的奇异值对应噪声)和缺失值插补，以及推荐系统中药物-靶标相互作用的矩阵补全。',
        relatedLinks: [{"label":"基因表达降噪 (学习路径 阶段2)","path":"/roadmap"},{"label":"药物-靶标矩阵补全 (应用方向)","path":"/applications"}] as const,
      },
    ],
    resources: [
    ...
    keyConcepts: [
      {
        ...
        relatedLinks: [{"label":"基因型推断 (应用方向)","path":"/applications"},{"label":"贝叶斯分类器 (学习路径 阶段2)","path":"/roadmap"}] as const,
      },
      {
        name: '贝叶斯定理',
        formula: 'P(A|B) = P(B|A)P(A) / P(B)',
        description: '从先验概率和似然推导后验概率的数学框架。在生物信息学中，贝叶斯定理是基因组变异检测(GATK HaplotypeCaller)和蛋白质结构预测(Rosetta)的核心，将先验生物学知识与观测数据融合。',
        relatedLinks: [{"label":"变异检测 (基因组学应用)","path":"/applications"},{"label":"朴素贝叶斯 (学习路径 阶段2)","path":"/roadmap"}] as const,
      },
      {
        name: '正态分布',
        ...
        relatedLinks: [{"label":"基因表达噪声建模 (应用方向)","path":"/applications"}] as const,
      },
      {
        name: '最大似然估计',
        ...
        relatedLinks: [{"label":"进化模型参数 (学习路径 阶段2)","path":"/roadmap"},{"label":"基因结构注释 (基因组学应用)","path":"/applications"}] as const,
      },
      {
        name: '期望与方差',
        ...
        relatedLinks: [{"label":"差异基因表达分析 (转录组学应用)","path":"/applications"},{"label":"批次效应量化 (应用方向)","path":"/applications"}] as const,
      },
    ],
    resources: [
    ...
    keyConcepts: [
      {
        ...
        relatedLinks: [{"label":"逻辑回归优化 (学习路径 阶段2)","path":"/roadmap"}] as const,
      },
      {
        name: 'SGD',
        ...
        relatedLinks: [{"label":"小批量训练 (学习路径 阶段2)","path":"/roadmap"},{"label":"PyTorch DataLoader (工具)","path":"/tools"}] as const,
      },
      {
        name: 'Adam',
        ...
        relatedLinks: [{"label":"默认优化器选择 (学习路径 阶段2)","path":"/roadmap"},{"label":"蛋白质语言模型训练 (应用方向)","path":"/applications"}] as const,
      },
      {
        name: '学习率调度',
        ...
        relatedLinks: [{"label":"学习率预热与衰减 (学习路径 阶段2)","path":"/roadmap"},{"label":"WandB实验跟踪 (工具)","path":"/tools"}] as const,
      },
      {
        name: '正则化',
        formula: 'L(θ) + λ||θ||²',
        description: '在目标函数中添加惩罚项以防止模型过拟合的技术。在生物信息学中，L2正则化(权重衰减)用于控制基因表达分类模型的复杂度，L1正则化(LASSO)用于从高维基因组数据中自动选择少量重要的生物标志物基因。',
        relatedLinks: [{"label":"LASSO基因选择 (转录组学应用)","path":"/applications"},{"label":"过拟合防止 (学习路径 阶段2)","path":"/roadmap"}] as const,
      },
    ],
    resources: [
    ...
    keyConcepts: [
      {
        ...
        relatedLinks: [{"label":"DNA序列保守性 (应用方向)","path":"/applications"}] as const,
      },
      {
        name: '交叉熵',
        ...
        relatedLinks: [{"label":"分类损失函数 (学习路径 阶段2)","path":"/roadmap"},{"label":"DeepVariant训练 (基因组学应用)","path":"/applications"}] as const,
      },
      {
        name: 'KL散度',
        ...
        relatedLinks: [{"label":"scVI隐空间约束 (单细胞应用)","path":"/applications"},{"label":"变分自编码器 (学习路径 阶段3)","path":"/roadmap"}] as const,
      },
      {
        name: '互信息',
        ...
        relatedLinks: [{"label":"基因调控网络推断 (转录组学应用)","path":"/applications"},{"label":"特征选择 (学习路径 阶段2)","path":"/roadmap"}] as const,
      },
      {
        name: '信息增益',
        ...
        relatedLinks: [{"label":"随机森林特征选择 (基因组学应用)","path":"/applications"},{"label":"决策树分裂准则 (学习路径 阶段2)","path":"/roadmap"}] as const,
      },
    ],
    resources: [
